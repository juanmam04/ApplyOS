        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 md:py-8">
          {backendDown && (
            <div className="mb-4 rounded-lg border border-red-500/40 bg-red-950/90 px-4 py-3 text-sm text-red-100">
              <strong>Sin backend:</strong> los datos y las acciones que usan la API no funcionan.{' '}
              {import.meta.env.PROD ? (
                <>Configurá <code className="text-white/90">VITE_API_URL</code> en Vercel apuntando a tu servidor Express.</>
              ) : (
                <>
                  Ejecutá <code className="text-white/90">npm run dev</code> y esperá{' '}
